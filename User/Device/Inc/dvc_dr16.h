...
public:
    ...
    inline void Set_Left_Switch(Enum_DR16_Switch_Status __Left_Switch);
    inline void Set_Right_Switch(Enum_DR16_Switch_Status __Right_Switch);
    inline void Set_DR16_Status(Enum_DR16_Status __DR16_Status);
 ...
 * @return float 遥控器右侧x轴摇杆状态
 */
void Class_DR16::Set_Right_X(float __Right_X)
{
    Data.Right_X = __Right_X;
}
 ...
 * @return float 遥控器右侧x轴摇杆状态
 */
void Class_DR16::Set_Right_Y(float __Right_Y)
{
    Data.Right_Y = __Right_Y;
}

void Class_DR16::Set_Left_X(float __Left_X)
{
    Data.Left_X = __Left_X;
}

void Class_DR16::Set_Left_Y(float __Left_Y)
{
    Data.Left_Y = __Left_Y;
}

void Class_DR16::Set_Left_Switch(Enum_DR16_Switch_Status __Left_Switch){
    Data.Left_Switch = __Left_Switch;
}

void Class_DR16::Set_Right_Switch(Enum_DR16_Switch_Status __Right_Switch){
    Data.Right_Switch = __Right_Switch;
}

void Class_DR16::Set_DR16_Status(Enum_DR16_Status __DR16_Status){
    DR16_Status = __DR16_Status;
}
#endif
